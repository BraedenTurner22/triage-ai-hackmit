      ...
      <div className="bg-gradient-to-r from-primary/10 via-primary/5 to-transparent rounded-xl p-6 shadow-inner">
        <div className="flex items-start justify-between">
          <div className="flex-1">
            <h2 className="text-3xl font-bold text-foreground mb-1">{patient.name}</h2>
            <div className="flex flex-wrap items-center gap-4 mt-3">
              ...
              <div className="flex items-center gap-2 bg-card/60 rounded-lg px-3 py-1.5">
                <div className={`w-3 h-3 rounded-full ${patient.gender === 'Male' ? 'bg-blue-500' : 'bg-pink-500'}`} />
          ...
          <Badge 
            className={`${getTriageColor(patient.triageLevel)} text-white border-0 px-4 py-2 text-lg font-bold shadow-lg`}
          >
        ...
        <div className="mt-4 bg-card/80 rounded-lg p-4 border border-border">
          <div className="flex items-center gap-2 mb-2">
            ...
            <span className="text-sm font-semibold text-muted-foreground uppercase tracking-wide">Chief Complaint</span>
          </div>
          <p className="text-lg font-medium text-foreground">{patient.chiefComplaint}</p>
        </div>
      </div>
            ...
            <CardContent className="p-0">
              <div className="bg-black aspect-video flex items-center justify-center relative">
                ...
                <div className="text-center">
                  ...
                  <p className="text-white/50">Video stream ready for VLM integration</p>
                  <p className="text-white/30 text-sm mt-1">Waiting for connection...</p>
                </div>
              </div>
            </CardContent>
          </Card>
            ...
            <CardContent className="p-6">
              {patient.aiSummary ? (
                <div className="space-y-4">
                  <div className="bg-gradient-to-br from-primary/10 to-primary/5 rounded-xl p-5 border border-primary/20">
                    <div className="flex items-center gap-2 mb-3">
                      ...
                      <p className="text-sm font-semibold text-primary uppercase tracking-wide">AI Assessment Summary</p>
                    </div>
                    <p className="text-foreground leading-relaxed">{patient.aiSummary}</p>
                  </div>
                    ...
                    <div className="bg-muted/50 rounded-lg p-3">
                      ...
                      <div className="flex items-center gap-2">
                        <div className="flex-1 bg-muted rounded-full h-2">
                          <div className="h-full bg-gradient-to-r from-primary to-green-500 rounded-full" style={{ width: '85%' }} />
                        </div>
                        <span className="text-sm font-bold">85%</span>
                      </div>
                    </div>
                    <div className="bg-muted/50 rounded-lg p-3">
                      <p className="text-xs font-medium text-muted-foreground mb-1">Analysis Time</p>
                ...
                <div className="text-center py-8">
                  ...
                  <p className="text-sm text-muted-foreground/70 mt-1">Processing patient data</p>
                </div>
              )}
            </CardContent>
          </Card>
